        ...
        <Formik
              ...
              return (
                  ...
                  <div className="row" style={{display: 'flex'}}>
                    <Form >
                        <CardContent>
                            <h6 style={{color:'blue', marginLeft: 'auto', marginRight: 'auto', textAlign: 'center'}} id="form" hidden>Aby dokończyć rejestrację, przejdź do swojej skrzynki pocztowej</h6>
