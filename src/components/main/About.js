...
export function About(){
    return <div style={{marginTop:80}}>
        ...
        <div className="containter">
            ...
            W swojej ofercie mamy ponad pięćdziesiąt samochodów z różnych kategorii, takich jak: sportowe, dostawcze, ekskluzywne, ekonomiczne, suvy, komfortowe.
        ...
        <div className="grid-container" style={{float: 'left', width:'100%'}}>
            <div className="grid-container" style={{float: 'left', width:'50%',textAlign:'center'}}>
                ...
                <br></br>
                <span style={{marginTop:320}}>Nasze samochody regularnie biorą udział w różnych wyścigach charytatywnych, podczas których zbierane są pieniądze na wiele zbiórek organizowanych przez fundacje!!</span>
            </div>
            <div className="grid-container" style={{float: 'right', width:'50%',textAlign:'center'}}>
                ...
                <br></br>
                <span style={{marginTop:320}}>Jesteśmy jednym ze sponsorów oraz partnerów lokalnej drużyny koszykówki, która osiąga wielkie sukcesy na szczeblu rozgrywek wojewódzkich oraz ogólnopolskich.</span>
            </div>
        </div>
        <br></br>
        <div className="grid-container" style={{float: 'right', width:'100%'}}>
            <div className="grid-container" style={{float: 'left', width:'50%',textAlign:'center'}}>
                ...
                <br></br>
                <span style={{marginTop:320}}>Bierzemy udział w wielu festiwalach oraz wystawach, aby zaprezentować uczestnikom część naszej floty pojazdów i przy tym zachęcić jak najwięcej osób do skorzystania z naszej oferty.</span>
            </div>
            <div className="grid-container" style={{float: 'right', width:'50%',textAlign:'center'}}>
                ...
                <br></br>
                <span style={{marginTop:320}}>Systematycznie wspieramy materialnie rodziny i osoby, które znajdują się w trudnej sytucji życiowej przekazując pieniądze na rzecz Szlachetnej Paczki.</span>
            </div>
        </div>
      <br></br>
